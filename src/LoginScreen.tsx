    ...
    <div className="flex flex-col min-h-screen bg-background-light max-w-[480px] mx-auto w-full relative">
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 pb-20">
        <div className="mb-8 flex flex-col items-center">
          ...
          <h1 className="text-3xl font-extrabold leading-tight text-center text-slate-900">Welcome Back</h1>
          <p className="text-slate-500 text-center mt-2 font-medium">Manage your money with confidence</p>
        </div>

        <div className="w-full space-y-5">
          <div className="flex flex-col w-full">
            <p className="text-slate-700 text-sm font-bold pb-2 px-1">Email</p>
          ...
          <div className="flex flex-col w-full">
            <p className="text-slate-700 text-sm font-bold pb-2 px-1">Password</p>
            <div className="relative">
