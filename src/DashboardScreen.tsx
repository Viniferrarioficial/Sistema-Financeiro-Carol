    ...
    <div className="flex flex-col min-h-screen bg-background-light max-w-[480px] mx-auto w-full pb-24">
      ...
      <header className="flex items-center bg-background-light p-4 sticky top-0 z-10 border-b border-primary/10">
        ...
        <div className="flex-1 px-3">
          <h1 className="text-xl font-extrabold leading-tight tracking-tight text-slate-900">Business Intelligence</h1>
          <p className="text-xs font-bold text-slate-500">Enterprise Performance Dashboard</p>
        </div>
      ...
      <section className="grid grid-cols-2 gap-4 p-4">
        ...
        <div className="flex flex-col gap-2 rounded-2xl p-5 bg-white shadow-sm border border-primary/5">
          ...
          <p className="text-2xl font-extrabold text-slate-900">$42,200</p>
          <div className="flex items-center gap-1">
      ...
      <main className="flex flex-col gap-6 px-4">
        ...
        <div className="rounded-2xl bg-white p-6 shadow-sm border border-primary/5">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-lg font-extrabold text-slate-900">Monthly Balance</h2>
              <p className="text-sm font-medium text-slate-500">Cashflow overview for 2024</p>
            </div>
            <div className="flex items-center gap-1 bg-primary/5 px-3 py-1.5 rounded-full">
              <span className="text-primary text-sm font-extrabold">$42,200</span>
        ...
        <div className="rounded-2xl bg-white p-6 shadow-sm border border-primary/5">
          <h2 className="text-lg font-extrabold mb-4 text-slate-900">Revenue by Category</h2>
          <div className="flex items-center gap-6">
            <div className="relative size-32 rounded-full border-[12px] border-primary flex items-center justify-center">
              ...
              <span className="text-xs font-extrabold text-slate-500">Global</span>
            </div>
            <div className="flex flex-col gap-3 flex-1">
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-2">
                  <div className="size-2.5 rounded-full bg-primary"></div>
                  <span className="text-slate-600 font-bold">SaaS</span>
                </div>
              ...
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-slate-600 font-bold">License</span>
                </div>
        ...
        {/* Top Customers */}
        <div className="rounded-2xl bg-white p-6 shadow-sm border border-primary/5">
          <h2 className="text-lg font-extrabold mb-4 text-slate-900">Top Customers</h2>
          <div className="flex flex-col gap-5">
            {[
              { id: 'TC', name: 'TechCorp Solutions', plan: 'Premium Plan', amount: '+$12,400' },
              { id: 'GN', name: 'Global Nexus', plan: 'Enterprise', amount: '+$8,200' },
              { id: 'AV', name: 'Apex Ventures', plan: 'Standard', amount: '+$5,100' }
            ].map((customer) => (
              <div key={customer.id} className="flex items-center gap-3">
                ...
                <p className="text-sm font-extrabold text-emerald-500">{customer.amount}</p>
              </div>
            ))}
          </div>
        </div>
